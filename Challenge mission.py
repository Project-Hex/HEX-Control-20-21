...
point4 = LocationGlobalRelative(52.784551, -0.709937, 20)
vehicle.simple_goto(point4, groundspeed=10)

while not (within_range(vehicle.location.global_frame,point4)):
    time.sleep(1)

print("Going towards waypoint 5")
point5 = LocationGlobalRelative(52.785167, -0.712351, 20)
vehicle.simple_goto(point5, groundspeed=10)

while not (within_range(vehicle.location.global_frame,point5)):
    time.sleep(1)

print("Going towards waypoint 6")
point6 = LocationGlobalRelative(52.783188, -0.714486, 20)
vehicle.simple_goto(point6, groundspeed=10)

while not (within_range(vehicle.location.global_frame,point6)):
    time.sleep(1)

print("Going towards waypoint 7")
point7 = LocationGlobalRelative(52.782552, -0.712984, 20)
vehicle.simple_goto(point7, groundspeed=10)

while not (within_range(vehicle.location.global_frame,point7)):
    time.sleep(1)

print("Going towards waypoint 8")
point8 = LocationGlobalRelative(52.782448, -0.707620, 20)
vehicle.simple_goto(point8, groundspeed=10)

while not (within_range(vehicle.location.global_frame,point8)):
    time.sleep(1)

print("Going towards waypoint 9")
point9 = LocationGlobalRelative(52.781565, -0.705893, 20)
vehicle.simple_goto(point9, groundspeed=10)

while not (within_range(vehicle.location.global_frame,point9)):
        time.sleep(1)
